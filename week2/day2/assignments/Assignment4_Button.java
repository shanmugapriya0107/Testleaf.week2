...
public class Assignment4_Button {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String cssValue = driver.findElement(By.xpath("(//span[@class='ui-button-text ui-c'])[6]")).getCssValue("background-color");
		...
		List<WebElement> findElements = driver.findElements(By.xpath("//button[@class='ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only rounded-button mr-2 mb-2']"));
